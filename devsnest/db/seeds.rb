...
Group.create(owner_id: 1,  name: 'first one')
Group.create(owner_id: 2,  name: 'sec one')
Group.create(owner_id: 3, name: 'third one')

GroupMember.create(user_id: 1, group_id: 1)
GroupMember.create(user_id: 2, group_id: 2)
GroupMember.create(user_id: 3, group_id: 3)

# WeeklyTodo.create(group_id: 1, creation_week: '2021-05-24', sheet_filled: true)
# WeeklyTodo.create(group_id: 1, creation_week: '2021-05-31')
# WeeklyTodo.create(group_id: 1, creation_week: '2021-05-24', sheet_filled: true)
# WeeklyTodo.create(group_id: 1, creation_week: '2021-06-07')
# WeeklyTodo.create(group_id: 1, creation_week: '2021-06-14', sheet_filled: true)
# WeeklyTodo.create(group_id: 1, creation_week: '2021-06-21')
# WeeklyTodo.create(group_id: 1, creation_week: '2021-06-28', sheet_filled: true)
# WeeklyTodo.create(group_id: 1, creation_week: '2021-07-05')

# WeeklyTodo.create(group_id: 2, creation_week: '2021-05-24')
# WeeklyTodo.create(group_id: 2, creation_week: '2021-05-31', sheet_filled: true)
# WeeklyTodo.create(group_id: 2, creation_week: '2021-05-24')
# WeeklyTodo.create(group_id: 2, creation_week: '2021-06-07', sheet_filled: true)
# WeeklyTodo.create(group_id: 2, creation_week: '2021-06-14', sheet_filled: true)
# WeeklyTodo.create(group_id: 2, creation_week: '2021-06-21')
# WeeklyTodo.create(group_id: 2, creation_week: '2021-06-28', sheet_filled: true)
# WeeklyTodo.create(group_id: 2, creation_week: '2021-07-05', sheet_filled: true)
