...
# Content.create(unique_id: 'link1', parent_id: 'arrays', name: 'yt_link1', data_type: 1, youtube_link: 'https://youtube.com/someting', priority: 4)
# Content.create(unique_id: 'link2', parent_id: 'arrays', name: 'yt_link2', data_type: 1, youtube_link: 'https://youtube.com/sometings', priority: 4)
...
# Content.create(unique_id: 'link3', parent_id: 'bst', name: 'yt_link3', data_type: 1, youtube_link: 'https://youtube.com/sometingsss', priority: 4)
# Content.create(unique_id: 'link4', parent_id: 'bst', name: 'yt_link4', data_type: 1, youtube_link: 'https://youtube.com/sometingsssss', priority: 4)
