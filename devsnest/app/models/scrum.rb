...
class Scrum < ApplicationRecord
  ...
  def self.create_scrum(context, batchmate_user_id, data, attendance, saw_last_lecture, till_which_tha_you_are_done, what_cover_today,reason_for_backlog)
    ...
    if batchmate_user_id == nil
      ...
      scrum = Scrum.create(user_id: batchmate_user_id, group_id: group_id, group_member_id: group_member.id, data: data, attendance: attendance, saw_last_lecture: saw_last_lecture, till_which_tha_you_are_done: till_which_tha_you_are_done, what_cover_today: what_cover_today, reason_for_backlog: reason_for_backlog)
      return scrum
    else
      return nil
    end
